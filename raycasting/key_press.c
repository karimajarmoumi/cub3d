...
/*   Updated: 2023/09/11 19:41:51 by kjarmoum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{ 
    ...
    map->player_pos.rotation_angle += map->player_pos.player_rotation* ROTATION_SPEED;
...
{
    float turn_angle;
    init_vars(&(map->player_pos.player_rotation), &(map->player_pos.player_moves), &turn_angle);
    if (code == LEFT)
    {
